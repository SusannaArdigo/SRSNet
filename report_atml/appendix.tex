...
\begin{table}[h]
  ...
  \begin{tabular}{l|ccccccc}
    \toprule
    Row vs Col & SRSNet & RSP & RSPNS & HypAF & RSPHyp & TASP & TASPHyp \\
    \midrule
    SRSNet                       & -- & +0.24 & +0.14 & +0.11 & +0.23 & -0.22 & +0.03 \\
    SRSNet\_RandomSP             & -0.22 & -- & -0.10 & -0.12 & -0.01 & -0.46 & -0.20 \\
    SRSNet\_RandomSPNoShuffle    & -0.12 & +0.10 & -- & -0.02 & +0.09 & -0.36 & -0.10 \\
    SRSNet\_HypernetAF           & -0.09 & +0.13 & +0.03 & -- & +0.12 & -0.33 & -0.07 \\
    SRSNet\_RandomSP\_HypernetAF & -0.20 & +0.01 & -0.09 & -0.11 & -- & -0.45 & -0.19 \\
    SRSNet\_TASP                 & +0.25 & +0.47 & +0.37 & +0.35 & +0.46 & -- & +0.27 \\
    SRSNet\_TASP\_HypernetAF     & -0.02 & +0.20 & +0.10 & +0.08 & +0.20 & -0.26 & -- \\
    \bottomrule
  \end{tabular}
  \end{center}
\end{table}
...
The factorial combinations are produced by a small factory
...
\verb|scripts/repro/paper_repro.py|; the resume behaviour means
re-running with the extended list of variants trains only the
missing cells.
